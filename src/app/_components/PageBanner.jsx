  ...
  return (
    <>
      ...
      <section
        className={
          type == 2
            ? "sb-banner sb-banner-sm sb-banner-color"
            : "sb-banner sb-banner-xs sb-banner-color"
        }
      >
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="sb-main-title-frame">
                <div
                  className={
                    type == 2 ? "sb-main-title text-center" : "sb-main-title"
                  }
                >
                  {type == 2 && (
                    <span
                      className="sb-suptitle sb-mb-30"
                      dangerouslySetInnerHTML={{ __html: clearBreadTitle }}
                    />
                  )}
                  <h1
